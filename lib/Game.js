...
// Decrease the size of the frog for collision detection effectiveness
    ...
    this.blocks = [
      ...
      new Block(550, 175, 20, 40, 'red', -1, 1, 'black'),
      new Block(600, 175, 10, 20, 'green', -1, 1, 'black'),
      new Block(650, 175, 10, 10, 'blue', -1, 1, 'black'),  
      new Block(700, 175, 20, 40, 'red', -1, 1, 'black'),
      new Block(850, 175, 10, 20, 'green', -1, 1, 'black'),
      new Block(900, 175, 10, 10, 'blue', -1, 1, 'black'), 

      new Block(550, 75, 20, 40, 'red', -1, 1, 'black'),
      new Block(600, 75, 10, 20, 'green', -1, 1, 'black'),
      new Block(650, 75, 10, 10, 'blue', -1, 1, 'black'),
      new Block(700, 75, 20, 40, 'red', -1, 1, 'black'),
      new Block(850, 75, 10, 20, 'green', -1, 1, 'black'),
      new Block(900, 75, 10, 10, 'blue', -1, 1, 'black'),
    ];
  }
